...
| Area | Stack |
|------|--------|
| **Frontend** | React, Next.js, TypeScript, JavaScript, HTML5, CSS3, Design Systems, performance & a11y |
| **Mobile** | React Native (Android & iOS), Expo/EAS, TypeScript |
| **Backend** | Node.js, NestJS, REST APIs, GraphQL, microservices |
| **Data** | PostgreSQL, MySQL, SQL Server, MongoDB |
| **DevOps** | Docker, AWS, CI/CD, Azure DevOps, Git |
| **Quality** | Jest, Testing Library, Cypress, Playwright, TDD, code review |
...
<details>
<summary><strong>Keywords</strong> (for recruiters / search)</summary>
